...
const products = productsFromServer.map(product => {
  const category =
    categoriesFromServer.find(
      paramCategory => paramCategory.id === product.categoryId,
    ) || null; // find by product.categoryId

  const user =
    usersFromServer.find(paramUser => paramUser.id === category.ownerId) ||
      ...
      <div className="block">
        <nav className="panel">
          ...
          <p className="panel-tabs has-text-weight-bold">
            ...
            {/* {products.filter((person, index) => {
              const unic = products.indexOf(person) === index;
